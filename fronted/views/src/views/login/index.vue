<template>
  <div class="login-container">
    ...
    <div class="login-form" style="margin-top:0px;padding-top:0px" v-show="loginButtonDiv">
      ...
      <el-button :loading="loading" type="warning" style="width:100%;margin-left: 0px;" @click.native.prevent="goRegister">注册</el-button>
    </div>

    <div class="login-form" style="margin-top:0px;padding-top:0px" v-show="registerButtonDiv">
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;" @click.native.prevent="handleRegister">注册</el-button>
      <el-button :loading="loading" type="warning" style="width:100%;margin-left: 0px;" @click.native.prevent="backLogin">返回登录</el-button>
    </div>
